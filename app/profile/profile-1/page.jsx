      ...
      <div class="p-8 bg-white shadow mt-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
          ...
          <div class="relative">
             ...
             <img class="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center text-indigo-500" src="/images/wework/team_1.jpg"/>
        ...
        <div class="mt-20 text-center border-b pb-12">
          ...
          <p class="font-light text-gray-600 mt-3">Tan Phu, Ho Chi Minh</p>{" "}
          ...
          <p class="mt-2 text-gray-500">FPT University</p>{" "}
        </div>{" "}
