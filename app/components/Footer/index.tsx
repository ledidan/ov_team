...
const products: ProductType[] = [
  {
    id: 1,
    section: "Trang",
    link: ["Khách hàng", "Dịch vụ", "Team", "Dự án", "Feedback", "FAQ"],
  },
  {
    id: 2,
    section: "Dịch vụ",
    link: ["Web APP", "Mobile APP", "IT consulting", "UI/UX System"],
  },
];
          ...
          <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
            <div>
              <h3 className="text-center md:text-start text-offwhite text-lg">
                @2023 - Sản phẩm độc quyền bởi{" "}
                <Link href="https://Software.ov.com.vn/" target="_blank">
                  {" "}
                  Software.ov.com.vn
                </Link>
              </h3>
            ...
            <div className="flex justify-center md:justify-end">
              <Link href="/">
                <h3 className="text-offwhite pr-6">Quy định bảo mật</h3>
              </Link>
              <Link href="/">
